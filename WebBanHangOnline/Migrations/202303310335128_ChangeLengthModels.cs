namespace WebBanHangOnline.Migrations
{
    ...
    public partial class ChangeLengthModels : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.tb_Posts", "SaleTitle", c => c.String(maxLength: 250));
            ...
            AlterColumn("dbo.tb_Product", "SaleTitle", c => c.String(maxLength: 250));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.tb_Product", "SaleTitle", c => c.String());
            ...
            AlterColumn("dbo.tb_Posts", "SaleTitle", c => c.String());
